...
<body class="flex items-center justify-center min-h-screen bg-gray-900 px-4">
    <div class="bg-gray-800 p-8 rounded-lg shadow-md w-full max-w-md sm:max-w-lg md:max-w-xl lg:max-w-2xl">
        <h1 class="text-2xl md:text-3xl font-extrabold mb-6 text-center text-white">Crear Producto</h1>
        ...
        <form action="{{ route('productos.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="nombre" name="nombre" required class="w-full p-2 border border-gray-600 rounded bg-gray-700 text-white">
            </div>
            ...
            <div class="mb-4">
                ...
                <textarea id="observaciones" name="observaciones" required class="w-full p-2 border border-gray-600 rounded bg-gray-700 text-white"></textarea>
            </div>
            ...
            <div class="mb-4">
                ...
                <select id="marca_id" name="marca_id" required class="w-full p-2 border border-gray-600 rounded bg-gray-700 text-white">
                    ...
                    <option value="{{ $marca->id }}" {{ $marca }}>{{ $marca->nombre }}</option>
                    @endforeach
                </select>
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="number" id="cantidad_inventario" name="cantidad_inventario" required class="w-full p-2 border border-gray-600 rounded bg-gray-700 text-white">
            </div>

            <div class="mb-4">
                <label for="fecha_embarque" class="block font-semibold text-white">Fecha de embarque:</label>
                <input type="date" id="fecha_embarque" name="fecha_embarque" required class="w-full p-2 border border-gray-600 rounded bg-gray-700 text-white">
            </div>

            <button type="submit" class="w-full bg-blue-600 text-white p-2 rounded hover:bg-blue-500 transition duration-200">Crear Producto</button>
        </form>
